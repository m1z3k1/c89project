...
*Assetsフォルダ：使用するものは全てこの下に。

*Assets/jsonフォルダ：データを管理するjsonファイルの置き場

*Assets/Pluginsフォルダ：外部ファイル

*Assets/prefabsフォルダ：prefabをまとめるフォルダ

*Assets/scriptフォルダ：.csファイルをまとめるフォルダ
